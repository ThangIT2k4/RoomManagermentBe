...
{
    [HttpGet]
    [ProducesResponseType(typeof(ApiResponse<PagedCapabilitiesResult>), StatusCodes.Status200OK)]
    public async Task<ActionResult<ApiResponse<PagedCapabilitiesResult>>> GetCapabilities(
