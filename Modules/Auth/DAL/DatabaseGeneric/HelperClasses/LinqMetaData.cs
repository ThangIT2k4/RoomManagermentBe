...
namespace RoomManagerment.Auth.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((RoomManagerment.Auth.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting CapabilityEntity instances in the database.</summary>
		public DataSource2<CapabilityEntity> Capability {	get { return new DataSource2<CapabilityEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting EmailOtpEntity instances in the database.</summary>
		public DataSource2<EmailOtpEntity> EmailOtp {	get { return new DataSource2<EmailOtpEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<SessionEntity> Session {	get { return new DataSource2<SessionEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
