...
public static class FinanceRequestHandlerRegistration
{
    public static IServiceCollection AddFinanceApplicationRequestHandlers(this IServiceCollection services)
    {
