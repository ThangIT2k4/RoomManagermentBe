...
namespace RoomManagerment.Notification.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, RoomManagerment.Notification.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((RoomManagerment.Notification.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public NotificationEntityFactory() : base("NotificationEntity", RoomManagerment.Notification.EntityType.NotificationEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(RoomManagerment.Notification.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(RoomManagerment.Notification.EntityType)))
			{
				var factory = GetFactory((RoomManagerment.Notification.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the RoomManagerment.Notification.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(RoomManagerment.Notification.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
	...
	{
		/// <summary>Gets the factory of the Entity type with the RoomManagerment.Notification.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (RoomManagerment.Notification.EntityType)Enum.Parse(typeof(RoomManagerment.Notification.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((RoomManagerment.Notification.EntityType)Enum.Parse(typeof(RoomManagerment.Notification.EntityType), leftOperandEntityName, false), joinType, (RoomManagerment.Notification.EntityType)Enum.Parse(typeof(RoomManagerment.Notification.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (RoomManagerment.Notification.EntityType)Enum.Parse(typeof(RoomManagerment.Notification.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((RoomManagerment.Notification.EntityType)entityTypeValue); }
