...
public interface IUserPermissionRepository
{
    ...
    Task<PagedResult<UserPermissionEntity>> GetByUserIdPagedAsync(Guid userId, int page, int pageSize, QueryFilter? filter = null, CancellationToken cancellationToken = default);
