...
public interface IRolePermissionRepository
{
    ...
    Task<PagedResult<RolePermissionEntity>> GetByRoleIdPagedAsync(Guid roleId, int page, int pageSize, CancellationToken cancellationToken = default);
    Task<PagedResult<RolePermissionEntity>> GetByPermissionIdPagedAsync(Guid permissionId, int page, int pageSize, CancellationToken cancellationToken = default);
