...
public interface IUserRoleRepository
{
    ...
    Task<PagedResult<UserRoleEntity>> GetByUserIdPagedAsync(Guid userId, int page, int pageSize, QueryFilter? filter = null, CancellationToken cancellationToken = default);
    Task<PagedResult<UserRoleEntity>> GetByRoleIdPagedAsync(Guid roleId, int page, int pageSize, QueryFilter? filter = null, CancellationToken cancellationToken = default);
