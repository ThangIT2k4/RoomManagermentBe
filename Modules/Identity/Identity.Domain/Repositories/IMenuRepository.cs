...
public interface IMenuRepository
{
    ...
    Task<IReadOnlyList<MenuEntity>> GetByParentIdAsync(Guid? parentId, CancellationToken cancellationToken = default);
    Task<IReadOnlyList<MenuEntity>> GetAllAsync(CancellationToken cancellationToken = default);
    Task<PagedResult<MenuEntity>> GetPagedAsync(int page, int pageSize, CancellationToken cancellationToken = default);
