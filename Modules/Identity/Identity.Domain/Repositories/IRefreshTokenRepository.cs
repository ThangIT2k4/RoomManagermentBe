...
public interface IRefreshTokenRepository
{
    ...
    Task<PagedResult<RefreshTokenEntity>> GetByUserIdPagedAsync(Guid userId, int page, int pageSize, QueryFilter? filter = null, CancellationToken cancellationToken = default);
