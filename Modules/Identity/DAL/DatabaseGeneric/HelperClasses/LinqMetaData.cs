...
namespace RoomManagerment.Identity.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((RoomManagerment.Identity.EntityType)typeOfEntity)
			{
		...
		public DataSource2<UserPermissionEntity> UserPermission {	get { return new DataSource2<UserPermissionEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting UserProfileEntity instances in the database.</summary>
		public DataSource2<UserProfileEntity> UserProfile {	get { return new DataSource2<UserProfileEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		...
		public DataSource2<MenuEntity> Menu {	get { return new DataSource2<MenuEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting MenuPermissionEntity instances in the database.</summary>
		public DataSource2<MenuPermissionEntity> MenuPermission {	get { return new DataSource2<MenuPermissionEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting UserMenuOverrideEntity instances in the database.</summary>
		public DataSource2<UserMenuOverrideEntity> UserMenuOverride {	get { return new DataSource2<UserMenuOverrideEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
