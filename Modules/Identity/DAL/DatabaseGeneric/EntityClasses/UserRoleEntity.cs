...
namespace RoomManagerment.Identity.EntityClasses
{
	...
	
	{
		...
		protected class UserRoleEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserRoleEntity", InheritanceHierarchyType.None, false, (int)RoomManagerment.Identity.EntityType.UserRoleEntity, typeof(UserRoleEntity), typeof(UserRoleEntityFactory), false);
				AddNavigatorMetaData<UserRoleEntity, RoleEntity>("Role", "UserRoles", (a, b) => a._role = b, a => a._role, (a, b) => a.Role = b, RoomManagerment.Identity.RelationClasses.StaticUserRoleRelations.RoleEntityUsingRoleIdStatic, ()=>new UserRoleRelations().RoleEntityUsingRoleId, null, new int[] { (int)UserRoleFieldIndex.RoleId }, null, true, (int)RoomManagerment.Identity.EntityType.RoleEntity);
				AddNavigatorMetaData<UserRoleEntity, UserEntity>("User", "UserRoles", (a, b) => a._user = b, a => a._user, (a, b) => a.User = b, RoomManagerment.Identity.RelationClasses.StaticUserRoleRelations.UserEntityUsingUserIdStatic, ()=>new UserRoleRelations().UserEntityUsingUserId, null, new int[] { (int)UserRoleFieldIndex.UserId }, null, true, (int)RoomManagerment.Identity.EntityType.UserEntity);
			}
		}
		...
		public UserRoleEntity(System.Guid roleId, System.Guid userId) : this(roleId, userId, null)
		{
		}
		...
		/// <param name="userId">PK value for UserRole which data should be fetched into this UserRole object</param>
		/// <param name="validator">The custom validator object for this UserRoleEntity</param>
		public UserRoleEntity(System.Guid roleId, System.Guid userId, IValidator validator)
		{
			InitClassEmpty(validator, null);
			this.RoleId = roleId;
			this.UserId = userId;
		...
		/// <remarks>Mapped on  table field: "user_roles"."user_id".<br/>Table field type characteristics (type, precision, scale, length): Uuid, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
